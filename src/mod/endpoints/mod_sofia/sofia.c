								...
								sofia_dispatch_event_t *de, tagi_t tags[])
{
	...
	int locked = 0;
	int check_destroy = 1;
	//switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "our_sofia_event@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@%d.\n", event);
	...
	case nua_r_invite:
		...
		break;
	case nua_r_options:
		//switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "ping333333333333333333333333333333333333333333333\n");
	...
	case nua_r_register:
		...
		break;
	case nua_i_options:
	    //switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "nua_i_options@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
	...
	case nua_i_message:
		...
		break;
	case nua_i_info:
   	    switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "nua_i_info-----------------------------------------\n");
...
void *SWITCH_THREAD_FUNC sofia_profile_worker_thread_run(switch_thread_t *thread, void *obj)
{
	...
	while ((mod_sofia_globals.running == 1 && sofia_test_pflag(profile, PFLAG_RUNNING))) {
		...
		//time_t now = switch_epoch_time_now(NULL);   //lifeng
        //sofia_reg_check_ping_expire(profile, now, 5);  //lifeng
        //switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_CRIT, "sofia_test_pflag(profile, PFLAG_ALL_REG_OPTIONS_PING):-------------->%d\n", sofia_test_pflag(profile, PFLAG_ALL_REG_OPTIONS_PING));   //lifeng
									   ...
									   tagi_t tags[])
{
	...
	if (gateway) {
	 	switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "ping111111111111111111111111111111111111111111111111.\n");
    	...
    	//switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_DEBUG, "ping2222222222222222222222222222222222222.\n");
